...
import { fetchAllInquiries, fetchInquiries, saveInquiries, updateMasterRow } from "../mock/api";
...
export function InquiryScreen({ productGroupEditor, hint, excelName }: Props) {
  ...
  return (
    <>
      ...
      <InquiryGrid
        ...
        productGroupEditor={productGroupEditor}
        hint={hint}
        ...
        onExcelDownload={() => {
          void (async () => {
            ...
            downloadExcel(allRows, `${excelName}_${stamp}`);
            setExcelLoading(false);
